...
SQL это очень популярная и известная вещь, по нему есть тысячи туториалов разной степени сложности. Например, на том же сайте [https://database.guide/sql-tutorial-for-beginners/](https://database.guide/sql-tutorial-for-beginners/)
