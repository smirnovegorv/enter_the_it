...
5. Создав все экземпляры всех классов, Spring пробегается по всем полям, помеченным специальной аннотацией @Autowired, и
